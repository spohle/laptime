  ...
  return (
    <div className="mt-6 min-w-0 sm:mt-8">
      <div className="mb-2 flex items-center justify-between sm:mb-3">
        <h2 className="pool-section-title text-base font-semibold sm:text-lg md:text-xl">Competition Pool</h2>
      </div>
      ...
      <div className="relative min-w-0 pb-2">
        ...
        {layout === 'strip20' ? (
          <div className="pool-rail-bg flex h-52 w-full min-w-0 max-w-full box-border gap-px p-1.5 sm:h-80 sm:gap-1 sm:p-3">
            {lanes.map((lane) => {
          ...
          <div className="pool-rail-bg p-2 sm:p-3">
